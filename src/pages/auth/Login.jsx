...
export default function Login() {
    ...
    return(
        <div className="mx-auto max-w-[450px] bg-white dark:bg-gray-800 shadow-[0_2.5rem_8rem_2rem_rgba(0,0,0,0.06)] dark:shadow-[0_2.5rem_8rem_2rem_rgba(0,0,0,0.15)] p-[30px] rounded-[5px] transition-colors duration-200">
            <span className="inline-block mb-3 text-center text-xs lg:text-base text-neutral-400 dark:text-gray-300">
            ...
            <form onSubmit={submit}>
                ...
                <div className='flex justify-between w-full mb-4'>
                    ...
                    <p className='inline-block text-sm text-right'>
                        <Link 
                            ...
                            className='inline-block ml-1 text-blue-600 dark:text-blue-400 hover:underline'
                        >
                ...
                <div className='mt-5 text-center'>
                    <p className='inline-block pl-4 text-sm text-gray-600 dark:text-gray-300'>
                        Don't have Account?
                        <Link 
                            to="/users/register" 
                            className='inline-block ml-1 text-blue-600 dark:text-blue-400 hover:underline'
